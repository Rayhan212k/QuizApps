...
public class Topic1_Q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic1_q1);
    ...
    public void Topic1Q1NextButtonFunction(View view)
    {
        ...
        if (Topic1Q1Obj.getCheckedRadioButtonId()==R.id.Topic1Q1cID)
        {
            Topic1Q1Mark += 2;
        }
        else
        ...
        // Sent intent into Q2
        Intent Topic1Q1Sent = new Intent(this, Topic1_Q2.class);
