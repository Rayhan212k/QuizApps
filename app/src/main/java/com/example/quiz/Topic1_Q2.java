...
public class Topic1_Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic1_q2);
    ...
    public void Topic1Q2NextButtonFunction(View view)
    {
        ...
        if (Topic1Q2Obj.getCheckedRadioButtonId()==R.id.Topic1Q2bID)
        {
            Topic1Q2Mark += 2;
        }
        else
        ...
        // Sent intent into Q3
        Intent Topic1Q2Sent = new Intent(this, Topic1_Q3.class);
