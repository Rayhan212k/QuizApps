...
public class Topic2_Q4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic2_q4);
    ...
    public void Topic1Q4NextButtonFunction(View view)
    {
        ...
        if (Topic1Q4Obj.getCheckedRadioButtonId()==R.id.Topic1Q4bID)
        {
            Topic1Q4Mark += 2;
        }
        else
        ...
        // Sent intent into Q5
        Intent Topic1Q4Sent = new Intent(this, Topic2_Q5.class);
