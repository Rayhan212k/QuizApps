...
public class Topic3_Q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topic3_q3);
    ...
    public void Topic1Q3NextButtonFunction(View view)
    {
        ...
        if (Topic1Q3Obj.getCheckedRadioButtonId()==R.id.Topic1Q3aID)
        {
            Topic1Q3Mark += 2;
        }
        else
        ...
        // Sent intent into Q4
        Intent Topic1Q3Sent = new Intent(this, Topic3_Q4.class);
